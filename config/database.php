...
class DATABASE_CONFIG {
  ...
  var $youtube = array( 'datasource' => 'youtube' );
  
  var $news = array( 'datasource' => 'news' );
  
  var $blogs = array( 'datasource' => 'blogs' );
    
  var $vimeo = array('datasource' => 'vimeo');
  
  var $bingnews = array( 'datasource' => 'bingnews' );

  var $jobs = array( 'datasource' => 'jobs' );
}
?>