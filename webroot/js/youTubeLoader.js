...
function onYouTubePlayerReady(playerId) {
	...
	if (checkObj()) {	
		...
		obj.addEventListener("onError", "onPlayerError");
	}
...
function setVideoData(objs) { 
	if (checkObj()) { 
		//alert("set video data")
		try {
			obj.setVideoData(objs); 
		} catch(e) {
			$(document).trigger('loaderror');
		}
