...
class Bingnews extends DatasourceCrawler
{
	function __construct() {
	}

	function crawlFeed($updatedSince = '', $tag = '', $datafeedId = 0) {
		$this->Bingnews =& ConnectionManager::getDataSource("bingnews");
		$results = $this->Bingnews->search($tag);
		return $this->insertDatarows($updatedSince, $tag, "bingnews", $datafeedId, $results);
	}
}

$crawler = new Bingnews();
